...
function legenda(num) {
		if(num == 1)
   			 document.getElementById("linkEscolhido").innerHTML = "Sugerir música";
		if(num == 2)
   			 document.getElementById("linkEscolhido").innerHTML = "Avaliar música";
		if(num == 3)	
			 document.getElementById("linkEscolhido").innerHTML = "Fila de músicas";
		if(num == 4)	
			 document.getElementById("linkEscolhido").innerHTML = "Contate";
		if(num == 5)	
			 document.getElementById("linkEscolhido").innerHTML = "Sair";
		if(num == 6)	
			 document.getElementById("linkEscolhido").innerHTML = "Music Player";
		if(num == 7)
   			 document.getElementById("linkEscolhido").innerHTML = "Ver lista de solitações";
		if(num == 8)
   			 document.getElementById("linkEscolhido").innerHTML = "Inserir música";
		if(num == 9)	
			 document.getElementById("linkEscolhido").innerHTML = "Ver suas músicas";
		if(num == 10)	
			 document.getElementById("linkEscolhido").innerHTML = " ";
			}
